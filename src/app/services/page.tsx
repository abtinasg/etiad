...
export const metadata = createPageMetadata({
  ...
  description:
    "خدمات ارزیابی، مشاوره و درمان اختلالات مصرف مواد در کلینیک خورشید مشهد. برنامه درمان پس از بررسی شرایط هر مراجعه‌کننده تعیین می‌شود.",
  path: "/services",
});
    ...
    <div className="section-padding bg-bg-warm">
      <Container>
        ...
        <SectionHeader
          ...
          description="برنامه درمان پس از بررسی شرایط هر مراجعه‌کننده تعیین می‌شود. برای اطلاعات بیشتر درباره هر خدمت، صفحه مربوطه را مطالعه کنید یا با کلینیک تماس بگیرید."
        />
