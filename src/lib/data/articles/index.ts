...
export const articles: Article[] = [
  {
    ...
    medicalReviewer: "دکتر سید هاشم سیادتی — [نیازمند تأیید بازبینی]",
    relatedServiceSlug: "detoxification",
  ...
  },
  {
    ...
    author: "تیم محتوای کلینیک خورشید",
    medicalReviewer: "دکتر سید هاشم سیادتی — [نیازمند تأیید بازبینی]",
    relatedServiceSlug: "family-therapy",
